 ...
 *
 * This class includes static methods to convert between the following entities and their respective DTOs:
 ...
 *
 * Note:
 * - For some relationships (e.g., nested objects or foreign key dependencies), related properties
 *   are partially handled in the DTO construction for ease of presentation.
 * - Full population of related objects and entities should be managed separately.
 * - Additional fields like calculated values or relational mappings are expected to be set up elsewhere.
 */
public class DTOMapper {
    ...
    public static CustomerDTO toDTO(Customer customer) {
        ...
        // loanCount should be set by the service or repository
        return dto;
    }
